...
while (input !== -1) {
  let input = parseInt(
    prompt(
      "메뉴를 선택해주세요 : 아메리카노 : 1 / 카페라테 : 2 / 카페모카 : 3 / 핫초코 : 4 / 과일주스 : 5 / 종료하기 : -1 "
    )
  );
...
// let answer = parseInt(prompt("메뉴 0번~4번"));
// let props = Object.keys(menu);

// console.log(props);
// console.log(menu[answer]);
// // console.log(`메뉴: ${props[answer][name]} , 가격: ${menu[props[answer]]}`);
